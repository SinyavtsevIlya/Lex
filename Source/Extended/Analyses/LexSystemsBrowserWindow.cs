...
namespace Nanory.Lex.UnityEditorIntegration
{
    public class LexSystemsBrowserWindow : EditorWindow
    {
        ...
        //             var system = view.TreeView.GetItemDataForIndex<EcsSystemBase>(index);
        ...
        //     }
        //     
        //     List<TreeViewItemData<EcsSystemBase>> BuildTree(EcsSystemBase rootSystem, int idStart)
        //     {
        //         var items = new List<TreeViewItemData<EcsSystemBase>>();
        //         var idCounter = idStart;
        //         var filter = view.SearchField.value?.ToLowerInvariant();
        //
        //         bool TryBuildItem(EcsSystemBase sys, out TreeViewItemData<EcsSystemBase> item)
        //         {
        //             var id = idCounter++;
        //             var children = new List<TreeViewItemData<EcsSystemBase>>();
        ...
        //             {
        //                 item = new TreeViewItemData<EcsSystemBase>(id, sys, children);
        //                 return true;
        //             }
        //
        //             item = default;
        ...
        // }
        //
        // private string GetSystemName(EcsSystemBase system)
        // {
        ...
        // }
        //
        // private string GetSystemClassName(EcsSystemBase system)
        // {
        ...
        // }
        //
        // private static bool IsOneFrameSystem(EcsSystemBase system) =>
