...
namespace Nanory.Lex.UnityEditorIntegration.Templates {
    sealed class TemplateGenerator : ScriptableObject {
        ...
        [MenuItem ("Assets/Create/Lex/Create Startup from template", false, -200)]
        ...
        [MenuItem ("Assets/Create/Lex/Systems/Create InitSystem from template", false, -199)]
        ...
        [MenuItem ("Assets/Create/Lex/Systems/Create RunSystem from template", false, -198)]
        ...
        [MenuItem ("Assets/Create/Lex/Components/Create Component from template", false, -197)]
